...
export const POST_CATEGORY_LABELS: PostCategory[] = [
  PostCategory.STUDY,
  PostCategory.TRAVEL,
  PostCategory.CLASS_REUNION,
  PostCategory.SHOPPING,
  PostCategory.FOOD,
  PostCategory.SPORTS,
  PostCategory.MUSIC,
  PostCategory.MOVIE,
...
export const POST_CATEGORY_DISPLAY_VI: Record<PostCategory, string> = {
