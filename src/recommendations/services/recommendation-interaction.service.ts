...
import { UserPostView, UserPostViewDocument } from '../schemas/user-post-view.schema';
...
export class RecommendationInteractionService {
    ...
    async trackInteraction(
        ...
        if (interactionType === PostInteractionType.VIEW) {
            await this.createUserPostView(userObjectId, postObjectId, PostViewSource.RECOMMENDATION);
        }
