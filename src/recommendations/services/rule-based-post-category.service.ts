...
export class RuleBasedPostCategoryService {
    private readonly keywordGroups: KeywordGroup[] = [
        {
            ...
            keywords: ['học', 'học tập', 'bài tập', 'đồ án', 'thi', 'kiểm tra', 'môn học', 'deadline môn', 'sinh viên', 'trường', 'đại học'],
        },
        {
            category: PostCategory.TRAVEL,
            keywords: ['du lịch', 'đi chơi', 'check in', 'check-in', 'đà lạt', 'vũng tàu', 'nha trang', 'phú quốc', 'hà nội', 'sài gòn', 'đà nẵng', 'hội an', 'resort', 'khách sạn'],
        },
        {
            category: PostCategory.CLASS_REUNION,
            keywords: ['họp lớp', 'bạn cũ', 'lớp cũ', 'kỷ niệm lớp', 'gặp lại bạn học', 'reunion'],
        },
        {
            category: PostCategory.SHOPPING,
            keywords: ['mua', 'mua sắm', 'sale', 'giảm giá', 'đặt hàng', 'order', 'săn sale', 'sản phẩm', 'shop'],
        },
        {
            category: PostCategory.FOOD,
            keywords: ['ăn', 'món ăn', 'quán ăn', 'nhà hàng', 'trà sữa', 'cà phê', 'cafe', 'bánh', 'bún', 'phở', 'cơm', 'đồ ăn'],
        },
        {
            category: PostCategory.SPORTS,
            keywords: ['bóng đá', 'thể thao', 'gym', 'chạy bộ', 'đá banh', 'cầu lông', 'bóng chuyền', 'tập luyện'],
        },
        {
        ...
        },
        {
            ...
            keywords: ['game', 'gaming', 'rank', 'combat', 'livestream game', 'liên quân', 'free fire', 'pubg', 'valorant', 'lol', 'liên minh'],
        },
        {
            category: PostCategory.TECHNOLOGY,
            keywords: ['công nghệ', 'lập trình', 'code', 'flutter', 'react', 'nestjs', 'mongodb', 'điện thoại', 'laptop', 'máy tính', 'ai', 'phần mềm'],
        },
        {
            category: PostCategory.WORK,
            keywords: ['công việc', 'công ty', 'đi làm', 'deadline', 'dự án', 'họp', 'meeting', 'task', 'sếp', 'đồng nghiệp'],
        },
        {
            category: PostCategory.FAMILY,
            keywords: ['gia đình', 'bố', 'mẹ', 'ba', 'má', 'cha', 'anh trai', 'chị gái', 'em gái', 'em trai', 'ông bà'],
        },
        {
        ...
        },
        {
            ...
            keywords: ['người yêu', 'crush', 'yêu', 'tình yêu', 'hẹn hò', 'bạn gái', 'bạn trai'],
        },
        {
            category: PostCategory.HEALTH,
            keywords: ['sức khỏe', 'bệnh', 'đau', 'khám bệnh', 'bác sĩ', 'dinh dưỡng', 'giảm cân', 'tăng cân', 'tập thể dục'],
        },
        {
            category: PostCategory.FASHION,
            keywords: ['thời trang', 'outfit', 'quần áo', 'áo', 'váy', 'giày', 'phối đồ', 'style'],
        },
        {
        ...
        },
        {
            ...
            keywords: ['tin tức', 'thời sự', 'xã hội', 'cập nhật', 'thông báo', 'breaking news'],
        },
        {
            category: PostCategory.EVENT,
            keywords: ['sự kiện', 'sinh nhật', 'tiệc', 'party', 'lễ hội', 'khai trương', 'đám cưới'],
        },
        {
        ...
        },
        {
            ...
            keywords: ['cuộc sống', 'hôm nay', 'tâm trạng', 'buồn', 'vui', 'mệt', 'chill', 'một ngày', 'đời sống'],
        },
    ];
    ...
    private scoreCategory(group: KeywordGroup, normalizedCaption: string): CategoryScore {
        const matchedKeywords = group.keywords
            .map((keyword) => this.normalize(keyword))
            .filter((keyword) => normalizedCaption.includes(keyword));

        const score = matchedKeywords.reduce((total, keyword) => total + this.getKeywordWeight(keyword), 0);
    ...
    private calculateConfidence(winner: CategoryScore, runnerUp?: CategoryScore): number {
        const baseConfidence = Math.min(0.95, 0.45 + winner.score * 0.12 + winner.matchedKeywords.length * 0.08);
        if (!runnerUp) {
